            ...
            <div className="relative flex items-top justify-center min-h-screen bg-gray-100 dark:bg-gray-900 sm:items-center sm:pt-0">
                ...
                <div className="max-w-6xl mx-auto sm:px-6 lg:px-8">
                    <div className="flex justify-center pt-8 sm:justify-start sm:pt-0">
                        ...
                        <svg width="163" height="163" viewBox="0 0 386 386" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <rect width="66" height="386" fill="#1C50D5"/>
                            <rect x="110" width="66" height="193" fill="#1C50D5"/>
                            <rect x="220" width="66" height="386" fill="#1C50D5"/>
                            <rect x="320" width="66" height="66" fill="#1C50D5"/>
                            <rect x="320" y="127" width="66" height="66" fill="#1C50D5"/>
                        </svg>
                    </div>
